...
function getUserProperties() {
  ...
  var userID = $("#varUserIdClientID").val();
  var userFirstName = "";
  var userLastName = "";
  var userBU = "";
  var userWorkPhone = "";
  /* _spPageContextInfo.webAbsoluteUrl is SharePoint JavaScript property to get dynamic site URL */
  var webUrl =
  ...
  $.ajax({
    ...
    success: function (data) {
      var results;
      if (
        data.d.UserProfileProperties == null ||
        data.d.UserProfileProperties == "undefined"
      ) {
        userFirstName = "";
        userLastName = "";
        userBU = "";
      ...
      $("#" + varUserFNameClientID).val(userFirstName);
      $("#" + varUserLNameClientID).val(userLastName);
      $("#" + varUserBUClientID).val(userBU);
      $("#" + varUserWrkPhoneClientID).val(userWorkPhone);
    },
    error: function (xhr, status, error) {
      console.log("Error is " + error);
      $("#" + varUserFNameClientID).val("");
      $("#" + varUserLNameClientID).val("");
      $("#" + varUserBUClientID).val("");
      $("#" + varUserWrkPhoneClientID).val("");
    },
  });
}
```
